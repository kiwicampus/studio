...
export class PinholeCameraModel {
  ...
  public distortNormalized(out: Vector2, point: Readonly<Vector2>): Vector2 {
    ...
    if (this.model === "fisheye" || this.model === "equidistant") {
      ...
      // TODO: implement fisheye/equidistant distortionCollapse annotationCheck failure on line R276Check failure: Unexpected 'todo' comment: 'TODO: implement fisheye/equidistant...'CI / lint (ubuntu-20.04)View detailsCode has alerts. Press enter to view.
      out.x = point.x;
      out.y = point.y;
      return out;
    }
